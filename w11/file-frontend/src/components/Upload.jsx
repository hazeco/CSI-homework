        ...
        {fileName ? (
          <>
            <svg className="w-8 h-8 text-slate-400" fill="currentColor" viewBox="0 0 20 20">
              ...
              <path fillRule="evenodd" d="M4.5 6.5a1 1 0 00-1 1v7a1 1 0 001 1h11a1 1 0 001-1v-7a1 1 0 00-1-1h-11zM4 9.414V8.5a.5.5 0 01.5-.5h11a.5.5 0 01.5.5v.914M6 12a1 1 0 100-2 1 1 0 000 2zm.282-4.282a1 1 0 000 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L10 10.586l-2.282-2.282a1 1 0 00-1.414 0z" clipRule="evenodd" />
            </svg>
